function [ ] = plot_coord_frame(fh, H )
...
%   Make sure hold on has been called before you do this. 
    ...
    if(fh ~= '')
        plot3(fh, [x_o x_1(1)],[y_o x_1(2)], [z_o x_1(3)], 'blue');
        plot3(fh, [x_o y_1(1)],[y_o y_1(2)], [z_o y_1(3)], 'green');
        plot3(fh, [x_o z_1(1)],[y_o z_1(2)], [z_o z_1(3)], 'red');
    else
