...
% Initialize object with pose and cad points
obj = SampledObject;
obj.pose = [0, 0, 0, 3, 3, 3];
% Cad Model Points
obj.cad_points = [-1, -1, -1; ...
                0, 0, 0; ...
                1, -1, 1];
obj.mm = mm;
obj.symbolics = symbolics;


% Our secret delta
secret_pose_delta = [0, 0, 0, 0, 0, 0.1];

%% Show the points, axes, and object
hold on;
% Plot axes for the origin
fh = plot_coord_frame(eye(4));
