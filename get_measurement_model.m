...
p_c_no_rotation = R_from_b_to_c*p;
p_c_only_offset = d_b_to_c;
...
% Chop off row of zeros
jacobian_of_measurement_model = jacobian_of_measurement_model(1:2, :);

symbolics = [f, phi, theta, psi, pose_x, pose_y, pose_z, ...
    off_x, off_y, off_z];